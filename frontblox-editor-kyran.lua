...
local UILibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/31KYRAN31/roblox-scirpt/main/fortblox-yan.lua"))();
...
local GetConfig = function()
    local read, data = pcall(readfile, "editor-kyran-esp.json");
    ...
    if (read and canDecode) then
        ...
        if (Decoded.Version ~= DefaultSettings.Version) then
            ...
            writefile("editor-kyran-esp.json", Encoded);
...
local Window = MainUI:LoadWindow('<font color="#ff4f57">kyran</font> esp', UDim2.fromOffset(400, 279));
